  ...
  return (
    <div className="policy-page">
      ...
      <main className="policy-main">
        <div className="policy-hero">
          ...
          <p className="policy-lead">
            ...
            when representatives use the Mail System and when students submit issue reports through this website,
            Microsoft 365 Forms, surveys, questionnaires or feedback channels linked from our announcements.
          </p>
          <table className="policy-document-control">
            ...
            <tbody>
              ...
              <tr><th scope="row">Effective date</th><td>1 July 2026</td><th scope="row">Last reviewed</th><td>20 July 2026</td></tr>
              <tr><th scope="row">Version</th><td>1.3</td><th scope="row">Next review</th><td>By 1 July 2027</td></tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="policy-content">
          ...
          <PolicySection number="03" title="Information we collect">
            ...
            <h3>Student issue reports, Microsoft 365 Forms and other submissions</h3>
            <p>Depending on the reporting route or form, we may collect:</p>
            <ul>
              ...
              <li>issue summaries, descriptions, requested outcomes, answers, ratings, opinions, free-text comments and files that you choose to submit;</li>
          ...
          <PolicySection number="04" title="How and why we use information">
            ...
            <ul>
              ...
              <li>receive student issue reports and administer surveys, questionnaires, polls, consultations and feedback exercises;</li>
          ...
          <PolicySection number="06" title="Microsoft 365 Forms and other service providers">
            ...
            <p>
              ...
              pages and protect the Service. Immutable email export records and reports submitted through the public
              issue-reporting page are stored in a Cloudflare D1 database configured for the European Union jurisdiction.
              The issue-reporting form does not store a local draft on the student&apos;s device. Links to third-party
              websites are governed by those websites&apos; own notices.
            </p>
          </PolicySection>

          <PolicySection number="07" title="Who can access information and when it may be shared">
            <p>
              Access to identifiable issue reports and form responses is limited to authorised Student Representatives and, where
          ...
          <PolicySection number="09" title="Retention and deletion">
            <ul>
              ...
              <li>Student issue reports, survey responses and questionnaire responses are normally retained for no longer than two years after submission or after the relevant form closes, then securely deleted or irreversibly anonymised.</li>
      ...
      <footer className="policy-footer">
        <div><strong>Document reference</strong><span>UOM-CHEM-SR-PRIV-001 · Version 1.3</span></div>
