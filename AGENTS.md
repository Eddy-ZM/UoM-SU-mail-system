...
- Full-screen notices must not shift the page behind them when opened or dismissed. Compensate for the removed scrollbar while scroll is locked, restore the original body styles exactly, and move focus without scrolling.
